...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="TBTracker.Azure" generation="1" functional="0" release="0" Id="85041f55-c152-4e07-bb8b-657a19e7502d" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="TBTracker.AzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="TBTracker" generation="1" functional="0" release="0" software="C:\Users\Jason\Documents\ic2012\TBTracker\TBTracker.Azure\csx\Release\roles\TBTracker" entryPoint="base\x86\WaHostBootstrapper.exe" parameters="base\x86\WaIISHost.exe " memIndex="1792" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="6ccf5508-04ce-4c7b-bdae-f78a64401954" ref="Microsoft.RedDog.Contract\ServiceContract\TBTracker.AzureContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="483f7bd3-0b40-4730-9545-4e9176fa1b52" ref="Microsoft.RedDog.Contract\Interface\TBTracker:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/TBTracker.Azure/TBTracker.AzureGroup/TBTracker:Endpoint1" />
          </inPort>
        </interfaceReference>
